...
describe('New user Entity investment funnel', function () {
  let userEmail = ''
  before(() => {
  ...
  xit('Invest as Entity using credit card', () => {
    ...
    recurseInvestmentSteps('info_new_entity', 'credit')
  ...
  xit('cancels an investment', () => {
    cancelInvestment()
  })

  xit('Invest as Entity using ACH', function () {
    cy.visit('/invest/tuttle-twins-2')
